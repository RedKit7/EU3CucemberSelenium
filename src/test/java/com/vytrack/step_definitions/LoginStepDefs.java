...
public class LoginStepDefs {
    ...
    public void the_user_enters_the_BA_information() {
        System.out.println("I enter BA username and password");
    }


    @When("the user enters the PO information")
    public void the_user_enters_the_PO_information() {
        System.out.println("I enter PO username and password");
    }
